...
public interface CustomerService {
     ...
     * @throws vn.fis.training.exception.DuplicateCustomerException : Khi khach hang da ton tai trong
     * he thong - dua vao truong mobile
     ...
     * @throws vn.fis.training.exception.DuplicateCustomerException : Khi khach hang da ton tai trong
     * he thong - dua vao truong mobile
     * @throws vn.fis.training.exception.CustomerNotFoundException : Khi khong tim duoc user tuong ung
     * voi id muon cap nhat trong he thong
    ...
    /**
     * @return : danh sach customer trong he thong order by name giam dan (theo thu tu abc).
     * Return emptyList neu khong co doi tuong nao
     * */
     ...
     * @return : danh sach  limit customer trong he thong order by name giam dan (theo thu tu abc).
     * Return emptyList neu khong co doi tuong nao
     * */
    List<Customer> findAllOrderByNameLimit(int limit);

    /**
     * @param custName : Dieu kien tim kiem . Vi du: "Nguyen Van" -> He thong tra ve tat ca cac customer
     *                 co chu chuoi ky tu : Nguyen Van, Khong phan biet hoa tuong
     * @param limit : So luong toi da Customer duoc tra ve
     * @return : danh sach  limit customer trong he thong order by name giam dan (theo thu tu abc).
     * Return emptyList neu khong co doi tuong nao
     * */
     ...
     * @return : Danh sach doi tuong SummaryCustomerByAgeDTO duoc sap xep theo thu tu Age GIAM DAM.
     * Neu khong co khach hang nao tra ve EmptyList
     */
